...
local mt = {
  __index = {
    ...
    handleKeypressed = function(self, keypressed)
...
local function keypressed(keyPressed)
  local t = inputTable
  local key = inputKey
  local c = inputCursor
...
keybordManager:keypressed_regester(function(keybordPress)
  keypressed(keybordPress)
end)
